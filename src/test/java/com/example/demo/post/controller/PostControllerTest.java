...
class PostControllerTest {
    ...
    void 사용자는_게시물을_단건_조회_할_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/posts/2"))
                ...
                .andExpect(jsonPath("$.writer.email").value("ohnam01@naver.com"))
                .andExpect(jsonPath("$.writer.nickname").value("ohnam01"));
    }
    ...
    void 사용자가_존재하지_않는_게시물을_조회할_경우_에러가_난다() throws Exception {
        ...
        // when
        // then
        mockMvc.perform(get("/api/posts/112313"))
                .andExpect(status().isNotFound())
                .andExpect(content().string("Posts에서 ID 112313를 찾을 수 없습니다."));
    }
